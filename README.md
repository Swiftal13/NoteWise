...
It only predicts if the text was typed. If there is a part which AI generea**ted, it does not predict any further till the person writes again ontop of it.
